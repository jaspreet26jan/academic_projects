...
call.center.input.data <- read.table("C:/Users/jaspr/OneDrive/Documents/Chapter_6/data_anonymous_bank_february.txt", 
...
# select thursday in February for the queueing model
...
hourly.arrival.rate <- calls.for.hour/4  # four Thursdays in February
...
# read in case data
bank.shifts.data.frame <- read.csv("C:/Users/jaspr/OneDrive/Documents/Chapter_6/data_anonymous_bank_shifts.csv")
